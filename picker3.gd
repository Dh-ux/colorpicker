...
@export_enum("red","green","grey","yellow","darkblue","lightblue","lightpurple","lightyellow","white","orange","lightgreen","blue","darkpurple","purple","darkorange") var color_type: String = "red"
